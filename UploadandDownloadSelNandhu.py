...
def update_excel_data(filePath, colName, searchItem, new_value):
...
file_path = "C:\\Users\\Dell\\Downloads\\Copy of download (1).xlsx"
fruit_name = "Apple"
newvalue = "500"
#update the excel sheet
update_excel_data(file_path, "price", "Apple", "500")
# upload
